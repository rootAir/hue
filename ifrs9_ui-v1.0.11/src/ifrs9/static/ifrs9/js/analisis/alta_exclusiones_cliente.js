  ...
  .ready(function () {
    ...
    $('#ifrs9_btnBuscar')
      .click(function (e) {
        ...
        //Ahora es necesaria una llamada a back para obtener los detalles del cliente
        $('.loadingDiv')
          .show();

        $.ajax({
          type: "post",
          data: "environment=" + environment + "&customer_id=" + $('#ifrs9_idCliente')
            .val(),
          dataType: "json",
          url: "get_detalle_cliente_alta_exclusion_cliente/",
          success: function (data) {
            $('.id_cliente')
              .text(data.customer_id.value);
            $('.nombre_cliente')
              .text(data.customer_name.value);
...
function submit_new_exclusion_by_customer() {
...
function limpiar_alta_exclusion_cliente() {
  var $picker0_aux = $($datepicker[0])
  var $picker1_aux = $($datepicker[1])
  var picker0 = $picker0_aux.pickadate('picker');
  var picker1 = $picker1_aux.pickadate('picker');
