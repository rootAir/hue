(function (scriptCode) {
  ...
  Feve.prototype = (function () {
    ...
    var initializeTable = function (table, clickTrFunctionEvent, sort, scrollY) {
    ...
    var initCustomersPage = function () {
      ...
      if (!customersSection.hasClass("initialized")) {
        ...
        // initializeTable($('#ifrs9_customers-table'), customersClickEvent, true, "auto");
    ...
    var initContratosPage = function () {
      ...
      if (!contratosSection.hasClass("initialized")) {
        ...
        // Inicializamos la tabla de Clientes
        // initializeTable($('#ifrs9_contratos-table'), ajustesClickEvent, false, "auto");
    ...
    var initListadoPage = function () {
      ...
      if (!listadoSection.hasClass("initialized")) {
        ...
        // Inicializamos la tabla de Clientes
        //initializeTable($('#ifrs9_listado-param-table'), listadoClickEvent, false, "auto");
    ...
    var initListadoOperPage = function () {
      ...
      if (!listadoSection.hasClass("initialized")) {
        ...
        // Inicializamos la tabla de Clientes
        // initializeTable($('#ifrs9_listado-operaciones-table'), listadoClickEvent, false, "auto");
    ...
    var initListadoReglasPage = function () {
      ...
      if (!listadoSection.hasClass("initialized")) {
        ...
        // Inicializamos la tabla de Clientes
        //initializeTable($('#ifrs9_listado-reglas-table'), listadoClickEvent, false, "auto");
    ...
    var initAjustesPage = function () {
      ...
      if (!ajustesSection.hasClass("initialized")) {
        ...
        // Inicializamos la tabla de Clientes
        //initializeTable($('#ifrs9_ajustes-table'), ajustesClickEvent, true, "auto");
    ...
    var initSettingsPage = function () {
      ...
      if (!settingsSection.hasClass("initialized")) {
        ...
        // Inicializamos la tabla de Clientes
        initializeTable($('#ifrs9_settings-table'), settingsClickEvent, true, "200px");
