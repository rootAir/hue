...
setup(
  ...
  package_dir = {'': 'src'},
  install_requires = ['setuptools', 'desktop', 'sortedcontainers'],
  entry_points = { 'desktop.sdk.application': 'ifrs9=ifrs9' },
  zip_safe = False,
  package_data = {
    # Include static resources.  Package_data doesn't
    # deal well with directory globs, so we enumerate
    # the files manually.
    'ifrs9': expand_package_data(
      ["src/ifrs9/templates", "src/ifrs9/static"],
      "src/ifrs9/")
  }
)
