...
CREATE EXTERNAL TABLE CD_IFRS9.MZ_PUBLIC1(
...
CREATE EXTERNAL TABLE CD_IFRS9.MZ_PUBLIC_1_1_1(
...
-- 2ª MARCAÇÃO
CREATE EXTERNAL TABLE CD_IFRS9.MZ_PUBLIC_1_1_2(
...
-- 3ª MARCAÇÃO
CREATE EXTERNAL TABLE CD_IFRS9.MZ_PUBLIC_1_1_3(
...
-- 4ª MARCAÇÃO
CREATE EXTERNAL TABLE CD_IFRS9.MZ_PUBLIC_1_1_4(
...
-- 5ª MARCAÇÃO
CREATE EXTERNAL TABLE CD_IFRS9.MZ_PUBLIC_1_1_5(
...
-- 6ª MARCAÇÃO
CREATE EXTERNAL TABLE CD_IFRS9.MZ_PUBLIC_1_1_6(
...
-- 7ª MARCAÇÃO
CREATE EXTERNAL TABLE CD_IFRS9.MZ_PUBLIC_1_1_7(
...
-- 8ª MARCAÇÃO
CREATE EXTERNAL TABLE CD_IFRS9.MZ_PUBLIC_1_1_8(
...
-- 9ª MARCAÇÃO
CREATE EXTERNAL TABLE CD_IFRS9.MZ_PUBLIC_1_1_9(
